...
class SupervisorConfig:
    ...
    max_tool_rounds: int = 0  # 0 = unlimited (no step cap)
    ...
    def validate(self) -> list[ConfigError]:
        ...
        if self.max_tool_rounds < 0:
            errors.append(ConfigError("supervisor", "max_tool_rounds", "must be >= 0 (0 = unlimited)"))
        return errors
...
def load_config(path: str, profile: str | None = None) -> AppConfig:
    ...
    if "supervisor" in raw:
        ...
        config.supervisor = SupervisorConfig(
            ...
            max_tool_rounds=s.get("max_tool_rounds", 0),
        )
