...
T = TypeVar("T", bound="GitCreateBranchRequest")
...
class GitCreateBranchRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        git_create_branch_request = cls(
            branch_name=branch_name,
            project_id=project_id,
            workspace=workspace,
        )

        git_create_branch_request.additional_properties = d
        return git_create_branch_request
