...
T = TypeVar("T", bound="ListDirectoryRequest")
...
class ListDirectoryRequest:
    ...
    Attributes:
        ...
        path (None | str | Unset): Relative path within the workspace (default: root)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_directory_request = cls(
            project_id=project_id,
            path=path,
            workspace=workspace,
        )

        list_directory_request.additional_properties = d
        return list_directory_request
