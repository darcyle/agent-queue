...
T = TypeVar("T", bound="GitChangedFilesResponse")


@_attrs_define
class GitChangedFilesResponse:
    """
    Attributes:
        project_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        git_changed_files_response = cls(
            project_id=project_id,
        ...
        git_changed_files_response.additional_properties = d
        return git_changed_files_response
