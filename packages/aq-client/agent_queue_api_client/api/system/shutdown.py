...
from ...models.shutdown_response_422 import ShutdownResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> ShutdownResponse | ShutdownResponse422 | None:
    ...
    if response.status_code == 422:
        response_422 = ShutdownResponse422.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ShutdownResponse | ShutdownResponse422]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ShutdownResponse | ShutdownResponse422
    """
