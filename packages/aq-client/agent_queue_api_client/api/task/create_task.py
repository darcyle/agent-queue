...
from ...models.create_task_response import CreateTaskResponse
from ...models.create_task_response_422 import CreateTaskResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateTaskResponse.from_dict(response.json())

        return response_200

    if response.status_code == 422:
        response_422 = CreateTaskResponse422.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        CreateTaskResponse | CreateTaskResponse422
    """
