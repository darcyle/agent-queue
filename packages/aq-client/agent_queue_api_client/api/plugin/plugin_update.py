...
from ...models.plugin_update_request import PluginUpdateRequest
from ...models.plugin_update_response import PluginUpdateResponse
from ...models.plugin_update_response_422 import PluginUpdateResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 422:
        response_422 = PluginUpdateResponse422.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        PluginUpdateResponse | PluginUpdateResponse422
    """
