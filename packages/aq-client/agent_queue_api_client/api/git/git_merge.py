...
from ...models.git_merge_request import GitMergeRequest
from ...models.git_merge_response import GitMergeResponse
from ...models.git_merge_response_422 import GitMergeResponse422
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GitMergeResponse.from_dict(response.json())

        return response_200

    if response.status_code == 422:
        response_422 = GitMergeResponse422.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        GitMergeResponse | GitMergeResponse422
    """
