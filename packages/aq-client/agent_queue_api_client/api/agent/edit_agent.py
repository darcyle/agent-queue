...
) -> EditAgentResponse422 | ListAgentsResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EditAgentResponse422 | ListAgentsResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Deprecated — agents are now derived from workspaces. Use edit_project or workspace commands instead.
...
def sync(
    *,
    ...
    Returns:
        EditAgentResponse422 | ListAgentsResponse
    """
