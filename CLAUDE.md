...
- **Subsystems:** `src/adapters/`, `src/discord/`, `src/git/`, `src/tokens/`, `src/chat_providers/`, `src/plugins/`, `src/memory_v2_service.py`, `src/prompt_builder.py`, `src/tool_registry.py`, `src/rule_manager.py`, `src/reflection.py`, `src/schedule.py`
